...
def filter_by_state(state_list: Iterable[list[dict]], normal_state: str = "EXECUTED") -> Iterable[list[dict]]:
...
def sort_by_date(date_list: Iterable[list[dict]], reverse_list: bool = True) -> Iterable[list[dict]]:
